	...
	public class PackageMap extends App
	{
		...
		protected override function init():void
		{
			...
			_bar.loadURL(ldr, function():void {
				var obj:Array = com.adobe.serialization.json.JSON.decode(ldr.data as String) as Array;
...
//			_vis.operators.add(new TreeMapLayout("data.size"));
			_vis.operators.add(new NodeLinkTreeLayout("topToBottom", 20, 5, 10));
...
//			}, Data.NODES, eq("depth",1)));
			...
			_vis.setOperator("nodes", new PropertyEncoder(nodes, "nodes"));
			_vis.setOperator("edges", new PropertyEncoder(edges, "edges"));
